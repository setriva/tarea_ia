...
/* Clase solución:
 * Esta clase es importante. La gracia es que reúne lo necesario para
...
public:
    ...
    void setTemperatura(long double temp);
...
//Parámetros de la solución
    ...
    vector<vector<int>> uso_procesos;			//recursos actualmente utilizados por los procesos (no incluye transitivos!)
    vector<vector<int>> uso_transitivo;			//recursos utilizados por la asignación inicial y que no se van a mover
    ...
    //Temperatura y límites de búsqueda
    int tam_busqueda;
